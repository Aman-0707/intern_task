...
// import 'package:intern_task/ArticleModel.dart';
...
//   List<Map<String, dynamic>> _scrapednxtData = [];
...
//     // await Future.wait([scrapeWebsite()]);
...
//           await dbHelper.insertArticle(articleData);
